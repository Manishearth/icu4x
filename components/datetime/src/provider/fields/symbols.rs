...
impl FieldSymbol {
    ...
    fn get_canonical_order(self) -> u8 {
        match self {
            ...
            Self::Hour(Hour::H11) => 19,
            Self::Hour(Hour::H12) => 20,
            Self::Hour(Hour::H23) => 21,
            Self::Minute => 23,
            Self::Second(Second::Second) => 24,
            Self::Second(Second::MillisInDay) => 25,
            Self::DecimalSecond(DecimalSecond::Subsecond1) => 32,
            Self::DecimalSecond(DecimalSecond::Subsecond2) => 33,
            Self::DecimalSecond(DecimalSecond::Subsecond3) => 34,
            Self::DecimalSecond(DecimalSecond::Subsecond4) => 35,
            Self::DecimalSecond(DecimalSecond::Subsecond5) => 36,
            Self::DecimalSecond(DecimalSecond::Subsecond6) => 37,
            Self::DecimalSecond(DecimalSecond::Subsecond7) => 38,
            Self::DecimalSecond(DecimalSecond::Subsecond8) => 39,
            Self::DecimalSecond(DecimalSecond::Subsecond9) => 40,
