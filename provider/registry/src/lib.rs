...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::datetime::provider::day_periods::DayPeriodRulesDesign1V1: DayPeriodRulesDesign1V1,
            icu::datetime::provider::day_periods::DayPeriodRulesDesign2V1: DayPeriodRulesDesign2V1,
